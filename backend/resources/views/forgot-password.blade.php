                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>You recently requested to reset your password for your Podio crm Systems account. Use the button below to reset it. <strong>This password reset is only valid for the next 24 hours.</strong></p>
                                            <!-- Action -->
