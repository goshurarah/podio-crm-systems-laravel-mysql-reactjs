...
import "./../ReferralsSignInForm/ReferralsSignInForm.css";
...
function ReferralsSignInForm() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post("/api/affiliates/login", payload);
      // localStorage.setItem("token", response.data.token);
      console.log(response,"ressss")
      localStorage.setItem("token", response?.data?.token);
      localStorage.setItem("affiliateusername",response?.data?.affiliate?.first_name);
                ...
                <div className="main_div_buttons_signin">
                  ...
                  <div className="d-flex justify-content-center">
                    <div className="d-flex flex-row">
                      ...
                      {/* {packagetype === "" ? null : (
                        <Link to="/guest">
                          <button className="grey_btn_guest_continue">
                            Continue as Guest
                          </button>
                        </Link>
                      )} */}
...
export default ReferralsSignInForm;
