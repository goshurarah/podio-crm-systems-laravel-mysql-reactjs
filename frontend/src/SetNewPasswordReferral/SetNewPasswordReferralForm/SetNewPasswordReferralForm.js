...
import "./../SetNewPasswordReferralForm/SetNewPasswordReferralForm.css"
...
function SetNewPasswordReferralForm() {
  ...
  return (
    ...
    <div className="main_div_newpassword_referral">
      <div className="row">
        <div className="col-lg-2 col-md-12 col-12"></div>
        <div className="col-lg-8 col-md-12 col-12">
          <div className="main_div_form_newpassword_referral">
            <div className="form_main_div_newpassword_referralpassword">
              <form onSubmit={newPasswordAction}>
                <div className="padding_div_form_newpassword_referral">
                  <p className="heading_in_form_newpassword_referralpassword">New Password</p>
                  {passwordMatch ? (
                  ...
                  <div className="input_style_firstname_newpassword_referralpassowrd">
                    <div className="d-flex flex-row">
                      ...
                      <input
                        ...
                        className="input_firstname_style_newpassword_referralpassword"
                      ...
                      <img
                        ...
                        className="eye_style_newpassword_referralpassword"
                ...
                <div className="main_div_buttons_newpassword_referral">
                  <button
                    className="orange_button_newpassword_referral"
                    type="submit"
                    disabled={loading}
                  >
              ...
              <div className="main_div_buttons_newpassword_referral">
                <p className="or_para_newpassword_referralpassword">Or</p>

                <Link to="/signin">
                  <button className="blue_button_newpassword_referral">Sign In</button>
                </Link>
              </div>
            </div>
          </div>
...
export default SetNewPasswordReferralForm
